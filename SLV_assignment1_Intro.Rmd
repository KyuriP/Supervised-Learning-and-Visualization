...
To take a closer look at the two regions with the highest and the lowest median, we plot the densities for the regions *Toscana*, *Trentino-Alto Adige*, *Calabria*, and *Molise*.
```{r groupdiff}
...
```{r, fig.cap = "Missingness of Price per Region"}
