...
These files contain the regional and provincial coding and geographical shape information which can be used cluster the [municipalities](https://en.wikipedia.org/wiki/Comune) in our `location` variable into their respective provinces and regions. 
...
The variable of our main interest `price` is highly skewed to the right given that mean (239,939) is far off to the right of the median (135,000) (see section \ref{ref:appendix} Appendix). We look into the distribution of the `price` further in detail. We create a boxplot to examine the outliers (see *Figure 1*). 
...
We skim through our cleaned dataset using the `skimr` package. This summary of the raw dataset can be found in the section \ref{ref:appendix} Appendix.
...
\textbf{1.} Are there any regional trends in the median housing prices and their absolute deviations in Italy? \

\textbf{2.} Are there any provincial trends in the median housing prices and their absolute deviations in Italy? \

\textbf{3.} Is there a correlation between the missingness of housing price and other variables? \

\textbf{4.} What are the most important predictors of housing prices in Italy? \
...
## Question 1: Regional Trends in the Median Housing Price and Absolute Deviations in Italy
...
***@Emilia: interpret the plots above, name the regions with highest and lowest values for the median and mad***

Interpretation goes here.

## Question 2: Provincial Trends in the Median Absolute Deviation of Housing Prices
...
## Question 3: Correlation Between Missingness of Price and Other Variables
...
## Question 4: The Most Important Predictors of Housing Price in Italy
